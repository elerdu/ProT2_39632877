...
<div class="container">
    ...
    <div class="col-md-6">
        <h2 class="text-primary mb-3">Nuestra Historia</h2>
        <p class="lead text-muted">
        Comenzamos como un pequeño emprendimiento con grandes sueños. Poco a poco, y con mucho esfuerzo, logramos consolidarnos como una plataforma confiable para quienes buscan productos variados, buenos precios y una atención al cliente cercana. Hoy, después de varios años en el mercado, seguimos creciendo sin perder nuestra esencia: escuchar a nuestros clientes, adaptarnos a sus necesidades y ofrecerles siempre lo mejor.
        </p>
    </div>
    </div>
    ...
    <div class="col-md-6">
        <h2 class="text-primary mb-3">Misión y Visión</h2>
        <p class="lead text-muted">
        Nuestra misión es acercar productos de calidad a cada hogar, brindando una experiencia de compra segura, rápida y satisfactoria. Queremos simplificar la vida de las personas a través de la tecnología, sin perder el trato humano que nos caracteriza y nuestra visión es ser una empresa líder en ventas online en Latinoamérica, con proyección internacional, reconocida por su innovación, eficiencia y compromiso con el cliente.
        </p>
    </div>
    </div>
...
<!-- Bloque 2: Texto izquierda, imagen derecha -->
    ...
    <div class="col-md-6">
        <h2 class="text-primary mb-3"> Nuestros Valores:</h2>
        <p class="lead text-muted"> •	Compromiso: Nos dedicamos con pasión a lo que hacemos y damos lo mejor en cada paso.</p>
        <p class="lead text-muted"> •	Confianza: Construimos relaciones duraderas basadas en la transparencia y el respeto. </p>
